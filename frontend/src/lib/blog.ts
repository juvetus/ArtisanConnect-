...
export const blogArticles: BlogArticle[] = [
  {
    ...
    coverImage: '/images/hero-artisan.jpg',
    coverAlt: { fr: 'Artisan camerounais dans son atelier', en: 'Cameroonian artisan in the workshop' },
  ...
  },
  {
    ...
    coverImage: '/images/tissu-africain.jpg',
    coverAlt: { fr: 'Tissu africain et savoir-faire textile', en: 'African fabric and textile craftsmanship' },
  ...
  },
  {
    ...
    coverImage: '/images/bijoux.jpg',
    coverAlt: { fr: 'Bijoux artisanaux présentés sur un tissu', en: 'Handcrafted jewellery displayed on fabric' },
  ...
  },
  {
    ...
    coverImage: '/images/sculpture.jpg',
    coverAlt: { fr: 'Sculpture en bois réalisée dans un atelier', en: 'Wooden sculpture made in a workshop' },
  ...
  },
  {
    ...
    coverImage: '/images/vannerie.jpg',
    coverAlt: { fr: 'Objet de vannerie artisanale', en: 'Handcrafted basketry item' },
  ...
  },
  {
    ...
    coverImage: '/images/poterie.jpg',
    coverAlt: { fr: 'Pièces de poterie artisanale', en: 'Handcrafted pottery pieces' },
    sources: [{ label: 'MINPMEESA - Ministère des PME, de l’Économie sociale et de l’Artisanat', url: 'https://www.minpmeesa.cm/' }],
    author: 'L’équipe ArtisanConnect',
    publishedAt: '2026-09-12',
    readingTime: 5,
  ...
  },
  {
    ...
    coverImage: '/images/couture.jpg',
    coverAlt: { fr: 'Création textile dans un atelier de couture', en: 'Textile creation in a sewing workshop' },
    sources: [{ label: 'MINPMEESA - site officiel', url: 'https://www.minpmeesa.cm/site/' }],
    author: 'L’équipe ArtisanConnect',
    publishedAt: '2026-09-12',
    readingTime: 5,
  ...
  },
  {
    ...
    coverImage: '/images/menuiserie.jpg',
    coverAlt: { fr: 'Objet en bois préparé dans un atelier', en: 'Wooden item prepared in a workshop' },
    sources: [{ label: 'Orange Cameroun', url: 'https://www.orange.cm/' }],
    author: 'L’équipe ArtisanConnect',
    publishedAt: '2026-09-12',
    readingTime: 5,
  ...
  },
  {
    ...
    coverImage: '/images/vannerie.jpg',
    coverAlt: { fr: 'Objets de vannerie réalisés par une communauté', en: 'Basketry items made by a community' },
  ...
  },
  {
    ...
    coverImage: '/images/hero-artisan.jpg',
    coverAlt: { fr: 'Artisan au travail dans son espace de production', en: 'Artisan working in a production space' },
  ...
  },
  {
    ...
    coverImage: '/images/hero-artisan.jpg',
    coverAlt: { fr: 'Artisan camerounais dans son espace de travail', en: 'Cameroonian artisan in the workshop' },
    sources: [
  ...
  },
  {
    ...
    coverImage: '/images/sculpture.jpg',
    coverAlt: { fr: 'Pièce d’artisanat d’art présentée dans un atelier', en: 'Craft art piece displayed in a workshop' },
    sources: [
  ...
  },
  {
    ...
    coverImage: '/images/hero-artisan.jpg',
    coverAlt: { fr: 'Artisan africain présentant son savoir-faire', en: 'African artisan presenting their craft' },
    sources: [
  ...
  },
  {
    ...
    coverImage: '/images/tissu-africain.jpg',
    coverAlt: { fr: 'Créations artisanales présentées sur un stand', en: 'Handcrafted creations displayed at a fair stand' },
    sources: [
