...
export const api = {
  ...
  deleteService: (id: string) =>
    ...
    updateCustomerRequestResponse: (id: string, data: { price?: number; days?: number; message?: string }) => patch(`/customer-requests/${id}/respond`, data),
    markCustomerRequestDelivered: (id: string) => post(`/customer-requests/${id}/delivered`, {}),
    payCustomerRequest: (id: string, data: { method: 'momo' | 'cash'; payerPhone?: string }) => post(`/customer-requests/${id}/pay`, data),
    confirmCustomerRequestMomo: (id: string) => post(`/customer-requests/${id}/pay/momo/confirm`, {}),
    confirmCustomerRequestCash: (id: string) => post(`/customer-requests/${id}/pay/cash/confirm`, {}),
