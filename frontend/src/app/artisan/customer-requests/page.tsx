...
type RequestItem = { id: string; category: string; city: string; neighborhood?: string | null; description: string; budgetMin?: number | null; budgetMax?: number | null; status: string; matchScore?: number; targeted?: boolean; alreadyAnswered?: boolean };
