...
@Module({
  imports: [TypeOrmModule.forFeature([CustomerRequest, User, Listing, Service, Shop]), NotificationsModule, EmailModule, StorageModule, SubscriptionsModule, MomoModule, WhatsAppModule],
