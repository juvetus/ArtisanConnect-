...
@Module({
  imports: [TypeOrmModule.forFeature([User, Listing, Order, Payment, ServiceOrder, Shop, Subscription, InstitutionalResource, InstitutionalProgram, ProgramApplication]), ShopsModule, EmailModule, ReportsModule],
